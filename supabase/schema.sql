...
create table public.transactions (
  ...
  payment_method            text not null default 'card' check (payment_method in ('card','bank_transfer','espees')),
...
create table public.payment_attempts (
  ...
  method                    text not null default 'card' check (method in ('card','bank_transfer','espees')),
  espees_payment_ref        text,
  espees_amount             numeric(14,2),
