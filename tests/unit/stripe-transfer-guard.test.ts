...
it.each([
  {
    ...
    manual_payout_reference: "Bank payment confirmed",
    stripe_transfer_id: null,
  },
  {
    status: "released",
    payout_method: "manual",
    manual_payout_reference: null,
    stripe_transfer_id: null,
  },
])(
  "blocks manually settled transactions before contacting Stripe",
  async (data) => {
