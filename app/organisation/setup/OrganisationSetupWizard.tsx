...
export default function OrganisationSetupWizard() {
  ...
  return (
    <OrganisationSetupShell
      currentStep={step === "review" ? "payment" : step}
      organisationName={form.name}
      planName={
        step === "organisation" || step === "profile"
          ? undefined
          : selectedPlan.name
      }
      planPrice={
            ...
            >
              ...
              <div className="rounded-2xl border border-blue-100 bg-blue-50/60 p-4">
                ...
                <p className="mb-3 mt-1 text-xs leading-5 text-slate-600">
                  This helps people understand who is publishing the
                  opportunity.
                </p>
                <select
          ...
          {step === "profile" && (
            ...
            >
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Optional information can be added or changed from the
                  workspace later.
                </p>
              </div>
            ...
            <div className="mt-8">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  ...
                  unlimited organisation-owned paid jobs, plus experience
                  placements with the Placement Passport.
                </p>
              </div>
