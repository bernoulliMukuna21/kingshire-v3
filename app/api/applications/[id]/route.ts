...
export async function PATCH(
  ...
  try {
    ...
    // Espees (ESP): hosted redirect payment. We are the escrow (funds land in
    // our merchant wallet); the payer confirms on redirect back. Free of card
    // fees and never subscription-gated.
    if (method === "espees") {
